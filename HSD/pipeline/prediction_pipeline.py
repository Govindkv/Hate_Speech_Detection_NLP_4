...
from HSD.entity.config_entity import DataTransformationConfig
    ...
    def predict(self,best_model_path,text):
        ...
        try:
            ...
            if pred>0.5:
                ...
                print("Hatefull And Abusive")
                return "Hatefull And Abusive"
            else:
                print("No Hateful Elements!")
                return "No Hateful Elements!"
        except Exception as e:
            raise CustomException(e, sys) from e
