...
from HSD.entity.config_entity import DataIngestionConfig
from HSD.entity.artifact_entity import DataIngestionArtifacts
...
class DataIngestion:
    ...
    def get_data_from_gcloud(self) -> None:
        try:
            logging.info("Entered the get_data_from_gcloud method of data ingestion classes")
    ...
    def unzip_and_clean(self):
        ...
        try:
            ...
            logging.info("Exited the unzip_and_clean method of Data_ingestion class")
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifacts:
        logging.info("Entered the initiate_data_ingestion method of Data class")
        ...
        try:
            ...
            logging.info("Unzipping file and split into train and valid")
